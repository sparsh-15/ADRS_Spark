          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 border border-slate-300/50 shadow-xl hover:shadow-2xl transition-all duration-500">
                ...
                <div className="aspect-video bg-gradient-to-br from-slate-200 via-gray-100 to-blue-200 rounded-2xl relative overflow-hidden group mb-8">
                  {/* Overlay gradient - non-blocking */}
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-700/10 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none"></div>

                  {/* Play icon - non-blocking */}
                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div className="w-20 h-20 bg-white/90 backdrop-blur-sm shadow-lg rounded-full text-blue-600 flex items-center justify-center border border-slate-200 transform group-hover:scale-110 transition-all duration-300">
                      <Play className="w-8 h-8 ml-1" fill="currentColor" />
                    </div>
                  </div>

                  {/* Video always on top, clickable */}
                  <video
