...
//   // Dummy review data with different sentiment types
//   const reviews = [
//     {
//       id: 1,
//       name: "Sarah Johnson",
...
//   // Get current review and two adjacent reviews for desktop view
...
//         {/* Mobile Review Carousel (single review) */}
...
//             <p className="text-gray-700 italic mb-4">"{currentReview.content}"</p>
//             <div
...
//             <button onClick={prevReview} className="bg-white rounded-full p-2 shadow hover:bg-gray-100">
//               <ChevronLeft className="h-6 w-6 text-gray-700" />
//             </button>
//             <button onClick={nextReview} className="bg-white rounded-full p-2 shadow hover:bg-gray-100">
//               <ChevronRight className="h-6 w-6 text-gray-700" />
//             </button>
//           </div>
//         </div>

//         {/* Desktop Review Display (3 reviews side by side) */}
...
//                   i === 1 ? "scale-105 border-2 border-purple-500" : "opacity-80"
//                 }`}
//               >
//                 <div className="flex items-center mb-4">
//                   <img
...
//           <button
//             onClick={prevReview}
//             className="bg-white rounded-full p-3 shadow hover:bg-gray-100 transition duration-300"
//           >
//             <ChevronLeft className="h-6 w-6 text-gray-700" />
//           </button>
//           <button
